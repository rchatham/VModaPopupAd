...
//    @IBOutlet weak internal var webViewContainer : UIView!
    ...
    @IBOutlet weak internal var viewContainer : UIView!
    ...
    /// View Type
    public var viewType : PopUpViewType = .Custom(view: UIView()) {
        didSet {
            updateView()
        }
    }
    ...
    /**
     Title text.
     If value is nil, displays web page's title.
...
//        let webView = view as! WKWebView
    ...
    /**
     Remove buttons
    */
    public func removeButtons () -> Self {
        self.buttonSettings.removeAll()
        return self
    }
